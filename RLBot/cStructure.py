...
def print_vector_3(name, vector):
	print(str(name) + "(X,Y,Z): " + str(round(vector.X, 2)) + "," + str(round(vector.Y, 2)) + "," + str(round(vector.Z, 2)))


def print_rotator(name, rotator):
	print(str(name) + "(Pitch,Yaw,Roll): " + str(rotator.Pitch) + "," + str(rotator.Yaw) + "," + str(rotator.Roll))
...
def printPlayerInfo(index, playerInfo):
	...
	print_vector_3("Location", playerInfo.Location)
	print_rotator("Rotation", playerInfo.Rotation)
	print_vector_3("Velocity", playerInfo.Velocity)
	print_vector_3("Angular Velocity", playerInfo.AngularVelocity)
...
def printBallInfo(ballInfo):
	print("Ball Info:")
	print_vector_3("Location", ballInfo.Location)
	print_rotator("Rotation", ballInfo.Rotation)
	print_vector_3("Velocity", ballInfo.Velocity)
	print_vector_3("Angular Velocity", ballInfo.AngularVelocity)
	print_vector_3("Acceleration", ballInfo.Acceleration)


def printBoostInfo(index, boostInfo):
	print("Boost Pad " + str(index))
	print_vector_3("Location", boostInfo.Location)
